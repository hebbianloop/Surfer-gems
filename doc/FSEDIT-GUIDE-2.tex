...
\lstset{ %
  ...
  otherkeywords={*,emacs,sudo, tkmedit, recon-all, freeview, recon-all-go, ship-data, launchfv, ls},           % if you want to add more keywords to the set
...
\date{\normalsize 6 November 2015} % Today's date or a custom date
